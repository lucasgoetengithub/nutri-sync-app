                ...
                <S.DataGridContainer>
                    <thead>
                        <S.TableRow>
                            ...
                            <S.TableHeader width="430px">Data</S.TableHeader>
                            <S.TableHeader width="200px">Hora</S.TableHeader>
                        </S.TableRow>
                    </thead>
                    <tbody>
                        {rows.map((item, index) => (
                        <S.TableRow key={index} even={index % 2 === 0}>
                            ...
                            <S.TableCell width="430px">{item.Data}</S.TableCell>
                            <S.TableCell width="200px">{item.Hora}</S.TableCell>
                        </S.TableRow>
                        ))}
                    </tbody>
                </S.DataGridContainer>
